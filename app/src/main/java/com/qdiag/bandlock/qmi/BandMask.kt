...
object BandCatalog {
    ...
    val LTE: List<Entry> = listOf(
        Entry(1,  "2100"),        Entry(2,  "1900 PCS"),
        Entry(3,  "1800+"),       Entry(4,  "AWS-1 1700/2100"),
        Entry(5,  "850"),         Entry(7,  "2600"),
        Entry(8,  "900"),         Entry(12, "700 a"),
        Entry(13, "700 c"),       Entry(17, "700 b"),
        Entry(18, "800 Lower"),   Entry(19, "800 Upper"),
        Entry(20, "800 DD"),      Entry(25, "1900+"),
        Entry(26, "850+"),        Entry(28, "700 APT"),
        Entry(30, "2300 WCS"),    Entry(38, "TDD 2600"),
        Entry(39, "TDD 1900"),    Entry(40, "TDD 2300"),
        Entry(41, "TDD 2500"),    Entry(42, "TDD 3500"),
        Entry(48, "TDD 3600 CBRS"), Entry(66, "AWS-3"),
        Entry(71, "600"),
    )

    val NR: List<Entry> = listOf(
        Entry(1,  "n1 2100"),     Entry(2,  "n2 1900"),
        Entry(3,  "n3 1800"),     Entry(5,  "n5 850"),
        Entry(7,  "n7 2600"),     Entry(8,  "n8 900"),
        Entry(20, "n20 800"),     Entry(25, "n25 1900+"),
